...
from housing_model.config.core import DATASET_DIR, TRAINED_MODELS_DIR, config
...
def load_pipeline(*, file_name: str) -> Pipeline:
    ...
    file_path = TRAINED_MODELS_DIR / file_name
...
def remove_old_pipelines(*, files_to_keep: t.List[str]) -> None:
    ...
    for model_file in TRAINED_MODELS_DIR.iterdir():
